	...
	//												s_execute_script( function() {  global_client_typing_mode = false;  } ); 
	//		}
			else if (cmd == 'execute script') { 
				global_client_typing_mode = true; 
				execute_script( function() {  global_client_typing_mode = false;  } );
			}
	////////////////		
			...
			else if (cmd == 'only two') ff(params, callback);
			else if (cmd == 'copy') copy(params, callback);
			else if (cmd == 'get solana balance') get_solana_balance(params, callback);
			...
			else if (cmd == 'mint nft solana') s_mint_nft_solana(params, callback);
			else if (cmd == 'mint nft solana mainnet') s_mint_nft_solana_mainnet(params, callback);
			else if (cmd == 'mint nft solana get metadata') s_mint_nft_solana_get_metadata(params, callback);
			else if (cmd == 'mint nft solana create metadata') s_mint_nft_solana_create_metadata(params, callback);
			else if (cmd == 'upload image to arweave') s_upload_image_to_arweave( params, callback);
			else if (cmd == 'step colors') s_step_colors(params, callback);
			else if (cmd == 'save script') client_save_script(params, callback);
			else if (cmd == 'destroy colors') s_destroy_colors(params, callback);
			else if (cmd == 'send to obvod7') send_to_obvod7(params, callback);
			...
			else if (cmd == 'horizontal half') client_horizontal_half(params, callback);
			else if (cmd == 'vertical half') client_vertical_half(params, callback);
			...
			else if ((cmd == 'bluestiks') ||(cmd=="digfrompng"))  { 
													global_client_typing_mode = true; 
													s_execute_script_param( cmd, function() {  global_client_typing_mode = false;  } ); 
			}
			...
			else if (cmd == 'right glue') client_right_glue(params, callback);
			else if (cmd == 'down glue') client_down_glue(params, callback);
			else if (cmd == 'plus n m') client_plus_nm(params, callback);
			else if (cmd == 'super paint over') client_super_paint_over(params, callback);
			else if (cmd == 'combo') client_combo(params, callback);
			else if (cmd == 'acombo') client_acombo(params, callback);
			...
			else if (cmd == 'fillx')  fillx(params, callback);  
			else if (cmd == 'filly')  filly(params, callback);  
			else 
			{
		...
		function check(cmd)
		{
			...
			else if (cmd == 'only two') return true;
			else if (cmd == 'select')  return true;
			else if (cmd == 'mint nft solana') return true;
			else if (cmd == 'mint nft solana mainnet') return true;
			else if (cmd == 'mint nft solana get metadata') return true;
			else if (cmd == 'mint nft solana create metadata') return true;
			else if (cmd == 'upload image to arweave') return true;
			else if (cmd == 'floor colors') return true;
			else if (cmd == 'crop lt') return true;
			else if (cmd == 'ident') return true;
			else if (cmd == 'get solana balance') return true;
			else if (cmd == 'send to obvod7') return true;
			else if (cmd == 'maximus') return true;
			else if (cmd == 'horizontal half') return true;
			...
			else if (cmd == 'right glue') return true;
			else if (cmd == 'down glue') return true;
			else if (cmd == 'plus n m') return true;
			...
			else if (cmd == 'super paint over') return true;
			else if (cmd == 'generate seed')  return true;
			else if (cmd == 'border minus')  return true;
			else if (cmd == 'bluestiks')  return true;
			...
			else if (cmd == 'vertical half') return true;
			...
			else if (cmd == 'fillx')  return true;
			else if (cmd == 'filly')  return true;
			else 
			{
				global_client_typing_mode = false;
