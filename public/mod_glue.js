function client_left_glue(params, callback)
{
	...
	//v combu nado peredavat dva md5 a na servere schit sogl plana operation
		...
		ident(cnv.id, 'ident', function(data){
			...
			//		console.log('md52='+md52);
					...
					textToServerAndReturnBlob(args, '/left_glue', function(blob)
					{
...
function client_right_glue(params, callback)
{
	// search for true-bordered canvas
	var cnv = getSelectedBorderedSaveCanvas();
	var from_script=false;
	...
	var h2 = cnv.height;
			...
			//		console.log('md52='+md52);
					...
					var args = 'md51='+encodeURIComponent(md51)+'&md52='+encodeURIComponent(md52);
					textToServerAndReturnBlob(args, '/right_glue', function(blob)
					{
...
function client_down_glue(params, callback)
{
	// search for true-bordered canvas
	var cnv = getSelectedBorderedSaveCanvas();
	var from_script=false;
	...
	var h2 = cnv.height;
			...
			//		console.log('md52='+md52);
					...
					var args = 'md51='+encodeURIComponent(md51)+'&md52='+encodeURIComponent(md52);
					textToServerAndReturnBlob(args, '/down_glue', function(blob)
					{
