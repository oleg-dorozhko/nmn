...
function copy(params, callback)
{
	...
	//normal-seed
	console.log("glob_last_selected_canvas_id="+glob_last_selected_canvas_id);
	if(glob_last_selected_canvas_id.indexOf('seed-canvas')==0) {
		
		document.getElementById(glob_last_selected_canvas_id).classList.toggle("seed-unbordered");
		document.getElementById(glob_last_selected_canvas_id).classList.toggle("seed-bordered");
		glob_last_selected_canvas_id = 'normal-' + glob_last_selected_canvas_id;
